...
def get_args():
    ...
    parser.add_argument('--clean_file', type=str, default='set01_drone01.wav')
    parser.add_argument('--noise_file', type=str, default='drone_sound.wav')
    parser.add_argument('--output_clean_file', type=str, default='0_clean_file.wav')
    parser.add_argument('--output_noise_file', type=str, default='0_noise_file.wav')
    parser.add_argument('--output_noisy_file', type=str, default='0_noisy_file.wav')
