...
from pathlib import Path
import argparse
from test_denoising_v4_pre import audio_classification_predict
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_fn', type=str, default='ckpt/keras_model_denoising_300_up_v1.h5',
                        help='model file to make predictions')
    parser.add_argument('--dataset_dir', type=str, default='/home/kms/nlp/dataset/test',
                        help='directory containing wavfiles to predict')
    parser.add_argument('--noise_dir', type=str, default='./data_noise/drone_siren_concat.wav',
                        help='directory containing noise to predict')
    parser.add_argument('--save_path', type=str, default='./results_json',
                        help='time in seconds to sample audio')
    parser.add_argument('--SAMPLING_RATE', type=int, default=16000, # 추후 48000으로 수정 
