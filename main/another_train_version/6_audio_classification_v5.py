...
from pathlib import Path
import argparse
from test_noisy_v5 import audio_classification_predict
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_fn_1', type=str, default='ckpt/keras_model_noisy_v3_v1.h5',
                        help='model file to make predictions')
    parser.add_argument('--model_fn_2', type=str, default='ckpt/keras_model_noisy_v4_v1.h5',
                        help='model file to make predictions')
